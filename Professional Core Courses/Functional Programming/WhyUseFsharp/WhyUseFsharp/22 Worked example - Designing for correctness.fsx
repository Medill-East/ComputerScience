...
//   /// Is cart paid for?    public bool IsPaidFor { get { return this.paidAmount > 0; } }

//   /// Readonly list of items    public IEnumerable<TItem> Items { get {return this.items; } }

//   /// add item only if not paid for    public void AddItem(TItem item)
//   {
//      if (!this.IsPaidFor)
//      {
//         this.items.Add(item);
...
//   /// remove item only if not paid for    public void RemoveItem(TItem item)
//   {
//      if (!this.IsPaidFor)
//      {
...
//   /// pay for the cart    public void Pay(decimal amount)
//   {
//      if (!this.IsPaidFor)
//      {
